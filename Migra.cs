...
namespace Migra
{
    public class Migra
    {
        ...
        {
            string driverPath = Path.Combine(Environment.CurrentDirectory, "drivers", "chromedriver-win32");
            string binaryPath = Path.Combine(Environment.CurrentDirectory, "drivers", "chrome-win32");
